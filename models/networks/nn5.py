...
class ResidualComplexNNwithattention(nn.Module):
    ...
    def forward(self, x):
        ...
        out = out + attention_out  # could also concatenate instead of sum here! (worth a try)
        ...
        out = self.sigmoid(self.fc7(out)) # use softmax for multi-class classification when appropriate
