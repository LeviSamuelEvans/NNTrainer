...
class GCNtransformer(nn.Module):
    ...
    def forward(self, x, edge_index, batch=None):
        ...
        cross_attention_output, _ = self.cross_attention(x, edge_features, edge_features)
        ...
        pooled_output = pooled_output.mean(dim=1)  # Aggregate over the sequence dimension
